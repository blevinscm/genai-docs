...
Original image (left):
[Kari Shea](https://unsplash.com/photos/person-taking-photo-of-grey-padded-chair-inside-room-ItMggD0EguY) on
[Unsplash](https://unsplash.com/). 
Edited image (right): Image generated using Imagen 2
(v.006) outpainting to expand image content with the original base image,
a new aspect ratio (4:3), and center justified horizontal and vertical
settings.
